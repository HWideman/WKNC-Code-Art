...
var baseFrequency = 25;
var frequencyDeviance = 25;
var myFrequency;
//////
...
Boid.prototype.posRegulation = function(){
  ...
  //if the boid's velocity is too low, speed it up randomly
  if(this.velocity.x < 3){
    this.acceleration.x += 1;
  }
  if(this.position.x == randomMinMax(0,width)){
    var beat = getBeatSpeed(myFrequency);
    this.acceleration.x = this.acceleration.x+beat;
  }
  ...
  if(this.position.y > 795 || this.position.y < 205){
    this.applyForce(this.seek(createVector(this.position.x+100,500)));
  }
...
Boid.prototype.update = function() {
  ...
  this.r = 10 + (freqSizeMultiplier*.7);
...
Boid.prototype.render = function() {
  ...
  fill(this.red, this.blue, this.green);
    ...
    if(this.position.x >= width-2){
      /* fill(randomMinMax(0, 225),
      randomMinMax(0, 225),randomMinMax(0, 225));*/
      this.red = randomMinMax(0, 225);
      this.blue = randomMinMax(0, 225);
      this.green = randomMinMax(0, 225);
    }
...
Boid.prototype.borders = function(){
  if(this.position.y < 200) this.velocity.y = 1;
  if(this.position.y > 800) this.velocity.y = -1 * this.velocity.y; 
