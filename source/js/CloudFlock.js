...
function CloudFlock(yPosMin,deltaX,numClouds,scale,saturationMod){
	...
	for(var i = 0; i < this.numClouds; i++){
		...
		this.yAssignment = this.yPosMin + (randomMinMax(0,300));
		var b = new Cloud(this.xStart,this.yAssignment,6,this.saturationMod,this.scale);
		this.addCloud(b);
	}
